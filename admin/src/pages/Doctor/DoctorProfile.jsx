  ...
  return profileData &&(
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-1g p-8 py-7bg-white'>
          {/* ------------ Doc Info  : name, degree, experience -------------*/}
          <p className='flex items-center gap-2 text-3x1 font-medium text-gray-700'>{profileData.name}</p>
